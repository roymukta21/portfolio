...
const App = () => {
  ...
  return (
    <div className={`bg-background-light dark:bg-background-dark font-display text-text-main dark:text-gray-100 overflow-x-hidden ${isDarkMode ? 'dark' : ''}`}>
      <ScrollIndicator />
      <MovingCursor />
      {/* Navigation */}
      <motion.nav 
      ...
      >
        <div className="container-max px-4 md:px-6">
          <div className="flex items-center justify-between py-4">
            ...
            >
              <Logo size="md" showText={true} className="text-text-main dark:text-white" />
            </motion.div>
            ...
            >
              {['home', 'about', 'services', 'skills', 'portfolio', 'contact'].map((item, index) => (
                <motion.button
                  key={item}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1">
              ...
              <div className="flex items-center gap-6 mt-8">
                <div>
                  <p className="text-3xl font-black text-text-main dark:text-white">50+</p>
                  <p className="text-text-muted dark:text-gray-400 text-sm">Projects</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-text-muted dark:text-gray-400 text-sm">Happy Clients</p>
                </div>
              </div>
            </div>
      ...
      {/* About Me */}
      <section className="about-section section-padding bg-white dark:bg-white/5" id="about">
        <div className="container-max">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="about-content">
              ...
              >
                I'm Mukta Roy, a passionate full-stack web developer with expertise in modern JavaScript frameworks and backend technologies. I love turning complex problems into simple, elegant solutions through clean, efficient code.
              </motion.p>
              ...
              >
                When I'm not coding, you'll find me exploring new technologies, contributing to open-source projects, or enjoying a good cup of coffee while debugging the latest challenge.
              </motion.p>
      ...
      <section className="section-padding relative overflow-hidden" id="services">
        ...
        <div className="container-max relative z-10">
          <div className="text-center mb-16">
            <span className="text-yellow-500 font-bold uppercase tracking-wider text-sm">Services</span>
            <h2 className="text-3xl md:text-4xl font-black mt-2 mb-4 text-text-main dark:text-white">What I Build & Design</h2>
            <p className="text-text-muted dark:text-gray-400 max-w-2xl mx-auto">
              I offer comprehensive digital solutions from concept to deployment, combining technical expertise with creative design thinking.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              <Card className="group hover:border-yellow-500/50 transition-all duration-300 relative overflow-hidden service-card">
                ...
                <CardHeader>
                  ...
                  <CardTitle className="text-text-main dark:text-white relative z-10">Frontend Development</CardTitle>
                </CardHeader>
                <CardContent>
                  <CardDescription className="text-text-muted dark:text-gray-400 leading-relaxed relative z-10">
                    Building responsive, interactive user interfaces using React, Next.js, and modern CSS frameworks like Tailwind CSS.
                  </CardDescription>
                </CardContent>
            ...
            >
              <Card className="group hover:border-purple-500/50 transition-all duration-300 relative overflow-hidden service-card">
                ...
                <CardHeader>
                  ...
                  <CardTitle className="text-text-main dark:text-white relative z-10">UI/UX Design</CardTitle>
                </CardHeader>
                <CardContent>
                  <CardDescription className="text-text-muted dark:text-gray-400 leading-relaxed relative z-10">
                    Creating intuitive and beautiful user experiences through research, wireframing, prototyping, and visual design.
                  </CardDescription>
                </CardContent>
            ...
            >
              <Card className="group hover:border-blue-500/50 transition-all duration-300 relative overflow-hidden service-card">
                ...
                <CardHeader>
                  ...
                  <CardTitle className="text-text-main dark:text-white relative z-10">Backend Development</CardTitle>
                </CardHeader>
                <CardContent>
                  <CardDescription className="text-text-muted dark:text-gray-400 leading-relaxed relative z-10">
                    Creating robust server-side applications with Node.js, Express, databases, and RESTful APIs for seamless data management.
                  </CardDescription>
                </CardContent>
                ...
                >
                  <motion.div
                    className="absolute -top-2 left-1/2 w-1.5 h-1.5 bg-blue-500 rounded-full -translate-x-1/2"
                  />
                </motion.div>
              </Card>
            </motion.div>
            ...
            >
              <Card className="group hover:border-green-500/50 transition-all duration-300 relative overflow-hidden service-card">
                ...
                <CardHeader>
                  ...
                  <CardTitle className="text-text-main dark:text-white relative z-10">Mobile Development</CardTitle>
                </CardHeader>
                <CardContent>
                  <CardDescription className="text-text-muted dark:text-gray-400 leading-relaxed relative z-10">
            ...
            >
              <Card className="group hover:border-orange-500/50 transition-all duration-300 relative overflow-hidden service-card">
                ...
                <CardHeader>
                  ...
                  <CardTitle className="text-text-main dark:text-white relative z-10">Full-Stack Solutions</CardTitle>
                </CardHeader>
                <CardContent>
                  <CardDescription className="text-text-muted dark:text-gray-400 leading-relaxed relative z-10">
                    End-to-end web application development with deployment, optimization, and maintenance for complete digital solutions.
                  </CardDescription>
                </CardContent>
                ...
                >
                  <motion.div
                    className="absolute -top-1 left-1/2 w-1 h-1 bg-orange-500 rounded-full -translate-x-1/2"
                  />
                </motion.div>
              </Card>
            </motion.div>
            ...
            <motion.div
              ...
              transition={{
                y: { duration: 6.5, repeat: Infinity, ease: "easeInOut", delay: 5 },
            ...
            >
              <Card className="group hover:border-indigo-500/50 transition-all duration-300 relative overflow-hidden service-card">
                ...
                <CardHeader>
                  ...
                  <CardTitle className="text-text-main dark:text-white relative z-10">Consulting</CardTitle>
                </CardHeader>
                <CardContent>
                  <CardDescription className="text-text-muted dark:text-gray-400 leading-relaxed relative z-10">
                    Strategic technology consulting, code reviews, architecture planning, and technical guidance for your projects.
                  </CardDescription>
                </CardContent>
                ...
                >
                  <motion.div
                    className="absolute top-0 left-1/2 w-1 h-1 bg-indigo-500 rounded-full -translate-x-1/2"
                  />
                </motion.div>
              </Card>
            </motion.div>
      ...
      {/* Skills */}
      <section className="skills-section section-padding bg-[#1b1b40] dark:bg-black text-white" id="skills">
        <div className="container-max">
          <motion.div 
          ...
          >
            ...
            >
              I constantly update my skills to stay current with the latest industry trends and technologies.
            </motion.p>
          </motion.div>
          ...
          >
            ...
            <div className="flex flex-wrap gap-3">
              {['Figma', 'Adobe XD', 'Sketch', 'VS Code', 'Git/GitHub', 'Docker', 'AWS', 'MongoDB', 'PostgreSQL', 'Postman', 'Webpack', 'Jest'].map((tool, index) => (
                <motion.div
                  key={tool}
                  initial={{ opacity: 0, scale: 0.8 }}
                  whileInView={{ opacity: 1, scale: 1 }}
        ...
        <div className="container-max">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6 mb-12">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-black mt-2 text-text-main dark:text-white">Featured Projects</h2>
            </div>
      ...
      {/* Contact */}
      <section className="section-padding bg-white dark:bg-white/5" id="contact">
        <div className="container-max">
          <div className="text-center mb-16">
            <span className="text-primary font-bold uppercase tracking-wider text-sm">Contact</span>
            <h2 className="text-3xl md:text-4xl font-black mt-2 text-text-main dark:text-white">Let's Work Together</h2>
            ...
            <div className="lg:col-span-2 flex flex-col gap-6">
              <Card>
                <CardContent className="p-6">
                  ...
                  <CardTitle className="font-bold text-text-main dark:text-white mb-1">Phone</CardTitle>
                  <CardDescription className="text-text-muted dark:text-gray-400 text-sm">+880 1794-239883</CardDescription>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <CardTitle className="font-bold text-text-main dark:text-white mb-1">Email</CardTitle>
                  <CardDescription className="text-text-muted dark:text-gray-400 text-sm">muktaroy520@gmail.com</CardDescription>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <CardTitle className="font-bold text-text-main dark:text-white mb-1">Location</CardTitle>
                  <CardDescription className="text-text-muted dark:text-gray-400 text-sm">Dhaka, Bangladesh</CardDescription>
                </CardContent>
              </Card>
            </div>
            {/* Contact Form */}
        ...
        <div className="container-max px-4 md:px-10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex flex-col md:items-start items-center gap-4">
              ...
              <p className="text-gray-400 text-sm">© 2026 Mukta Roy. All rights reserved.</p>
            </div>
